				...
				<div class="form-fiche__encadre">
					...
					<div class="form-fiche__colonne-inputs">
						<div class="form-fiche__label-input-vertical form-fiche__label-input-vertical--sans-bordure">
							...
							<p v-if="erreurs.candidat" class="validForm error-message">
						...
						<div class="form-fiche__colonnes-inputs">
							<div class="form-fiche__colonne-inputs">
								...
								<div class="form-fiche__label-input-vertical">
									...
									<select id="edit-demande-region" name="edit-demande-region"
									...
									<p v-if="erreurs.province" class="validForm error-message">
										Veuillez effectuer un choix.
									</p>
								</div>
							</div>
					...
					<div class="form-fiche__label-input-vertical">
						...
						<textarea id="edit-demande-competences" name="edit-demande-competences" rows="6"
						...
						<div class="form-fiche__colonnes-inputs">
							...
							<div class="form-fiche__colonne-inputs">
								...
								<div class="form-fiche__label-input-vertical">
									...
									<div>
										<input type="radio" id="edit-demande-non-renumere"
											   name="edit-demande-remuneration"
							...
							<div class="form-fiche__colonne-inputs">
								<div class="form-fiche__label-input-vertical">
									...
									<input type="date" id="edit-demande-date-debut" name="edit-demande-date-debut"
										   v-model.trim="dateDebut" />
									<p v-if="erreurs.startDate" class="validForm error-message">
										Veuillez effectuer un choix.
									</p>
								</div>
								<div class="form-fiche__label-input-vertical">
									...
									<p v-if="erreurs.endDate" class="validForm error-message">
										Veuillez effectuer un choix.
									</p>
								</div>
							</div>
...
<script setup>
	...
	const validerFormulaire = () => {
		...
		erreurs.value.skills = ((demande.value.skills === undefined) || (demande.value.skills === '')),
			erreurs.value.internshipType = ((demande.value.internshipType === undefined) || (demande.value
				.internshipType === '')),
			erreurs.value.weeklyWorkHours = (demande.value.weeklyWorkHours === 0 || demande.value.weeklyWorkHours ===
				undefined || demande.value.weeklyWorkHours === ''),
		...
		try {
			...
			if (!formulaireValide.value) {
				demande.value.candidate.firstName = nomDuCandidat.value.substring(0, nomDuCandidat.value.indexOf(
					' '));
				demande.value.candidate.lastName = nomDuCandidat.value.substring(nomDuCandidat.value.indexOf(' ') +
					1);
				listerCompetences();
	...
	onMounted(async () => {
		...
		activitySectorInput.value = secteursActivites.value[Math.floor(Math.random() * secteursActivites.value
			.length)];
